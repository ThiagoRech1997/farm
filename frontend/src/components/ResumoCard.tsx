...
const ResumoCard: React.FC<ResumoCardProps> = ({ titulo, valor, icone, cor }) => {
  return (
    <div className={`flex flex-col items-center justify-center rounded-xl shadow-lg p-6 min-w-[140px] bg-white bg-opacity-80 backdrop-blur-md border-b-4 ${cor || 'border-green-400'}`}> 
